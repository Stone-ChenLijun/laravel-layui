    ...
    <script>
        layui.use(['table', 'layer', 'form', 'jquery'], function () {
            ...
            let tableIns = table.render({
                ...
                cols: [[
                    ...
                    , {field: 'path', title: '图片(点击预览)', align: 'center', event: 'preview', templet: function (d) {
                            return '<img class="ablum-image" src="' + d.preview_url + '">';
                        }}
            ...
            $('#btn-add').click(function () {
                window.location.href = '{{ route('view.carousel.add') }}';
            });
                            ...
                            "data": [
                                {
                                    "alt": obj.data.name,
                                    "pid": obj.data.id,
                                    "src": obj.data.preview_url,
                                }
                            ]
                        }
                    });
                } else if (obj.event === 'edit') {
                    window.location.href = '{{ route('view.carousel.edit') }}?id=' + obj.data.id;
