    ...
    <div class="layui-form layui-form-pane do-form-half">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="name" class="layui-input" autocomplete="off" maxlength="32" placeholder="请输入角色名称，限长32个字符">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label required">排序</label>
            <div class="layui-input-block">
                <input type="number" name="sort" class="layui-input" autocomplete="off" placeholder="请输入排序值[-999,999]">
            </div>
        </div>
        <div class="layui-form-item">
